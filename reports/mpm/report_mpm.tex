...
$t0 = 0.0 s$ e termina $t_n = 1.0 s$, com um passo de $dt \approx 0.000488 s$, resultando em um sinal com $2048$ pontos, de maneira 
a se adequar ao padrão de medidas clínicas. O sinal 
 

\subsection{Testagem de L sem ruído.}
Foi testado, para o algoritmo implementado, como as variáveis resultantes do processo variavam em estimativa
